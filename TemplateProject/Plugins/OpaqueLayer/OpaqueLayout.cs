...
namespace WindCommon.Plugins.OpaqueLayer
{
    /// <summary>
    /// 自定义控件:半透明控件
    /// </summary>
    [ToolboxBitmap(typeof(OpaqueLayout))]
    public class OpaqueLayout : System.Windows.Forms.Control
    {
        //是否使用透明
        ...
        public OpaqueLayout(int Alpha, bool IsShowLoadingImage)
        {
        ...
        [Category("OpaqueLayout"), Description("是否使用透明,默认为True")]
        ...
        [Category("OpaqueLayout"), Description("设置透明度")]
        public int Alpha
        {
            get
            {
